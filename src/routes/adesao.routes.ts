...
router.get("/estatisticas/resume", (req, res) =>
  controller.obterEstatisticas(req, res),
);
router.get("/paciente/:id_paciente", (req, res) =>
  controller.listarPorPaciente(req, res),
);
router.get("/:id", (req, res) => controller.obterPorId(req, res));
router.put("/:id", (req, res) => controller.atualizar(req, res));
router.patch("/:id/marcar-tomado", (req, res) =>
  controller.marcarComoTomado(req, res),
);
